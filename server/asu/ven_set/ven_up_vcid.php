...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try{        
            ...
            $sql = "UPDATE ven SET ven_com_id=:ven_com_id, ven_com_name=:ven_com_name, ven_com_num_all=:ven_com_num_all  WHERE id = :id";   
            ...
            http_response_code(200);
            echo json_encode(array('status' => true, 'message' => 'ok', 'responseJSON' => count($data_event->ven_com_id).' '. $x .' '. json_encode($va)  ));
            exit;  
