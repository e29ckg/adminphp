                                                ...
                                                <tr v-for="d,index in datas">
                                                    ...
                                                    <td>
                                                        <p @click="view(d.id)">
                                                            ...
                                                            <b>{{d.id}}{{d.name}} </b> 
                                                            <span :class="'badge text-sm ' + (d.status == 1 ? 'bg-primary' : 'bg-danger')">{{d.status == 1 ? '(ปกติ)' : '(ระงับการใช้งาน)'}}</span>
                                                            <br>token : {{d.token}}
                                                    ...
                                                    <td>
                                                        ...
                                                        <button class="btn btn-primary btn-sm me-2 mb-1" @click="user_update_role(d.id)">แก้ไขสิทธ์</button>    
                                                    </td>
                                                </tr>                                                
                                            </tbody>
                                            </table>
                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form @submit.prevent="line_insert">
                                    <!-- <div class="row"> -->
                                        <div class="col mb-3">
